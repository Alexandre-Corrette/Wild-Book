...
function card() {
...

  {
    ...
    altPortrait: "Portrait Massinta AIT BRAHAM",
    name: "Massinta AIT BRAHAM",
    position: "Développeur web",
...
document.querySelector('.clement').addEventListener("click", togglePopup)
document.querySelector('.romain').addEventListener('click', copyToClipboard)
document.querySelector('.mailClement').addEventListener('click', copyToClipboard)
